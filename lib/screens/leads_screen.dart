                  ...
                  builder: (context) {
                    ...
                    if (contextCtr.leadDataList.isEmpty) {
                      return SizedBox(
                          ...
                          height: GetDeviceType().getDeviceType(context)?MediaQuery.of(context).size.height*0.45 : MediaQuery.of(context).size.height*0.6,
                          child: Column(
                            children: [
                              SizedBox(
                                width: MediaQuery.of(context).size.width,
                              ...
                              Image.asset(
                                notApplication,
                                height: GetDeviceType().getDeviceType(context)?MediaQuery.of(context).size.height*0.15 : MediaQuery.of(context).size.height*0.2,
                                fit: BoxFit.contain,
                              ),
                              const SizedBox(height: 14),
                              const Text(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                            color: leadData.leadStatus.toString() == "In Progress"
                                ? lightRedSec
                                : leadData.leadStatus.toString() == "Successfully Disbursed"
                                    ? lightGreenSec
                                    : lightPink,
                            borderRadius: BorderRadius.circular(4)),
